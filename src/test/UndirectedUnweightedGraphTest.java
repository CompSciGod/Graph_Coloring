...
public class UndirectedUnweightedGraphTest {
   ...
   public void getNumVerticesTest3() {
      ...
      catch(Exception ex){exceptionThrown = true; System.out.println(ex.getMessage());}
   ...
   @Test 
    ...
    @Test 
     ...
     @Test 
      ...
      catch(Exception ex){addEdgeExceptionThrown = true; ex.printStackTrace();}
      ...
      @Test 
       ...
       try{
          adjData = graph.getAdjacentData(500);
          correctAdj = (adjData.size()==3 && adjData.contains(100) && adjData.contains(200) && adjData.contains(400));
       }
       catch(Exception ex){getAdjExceptionThrown = true; ex.printStackTrace();};
